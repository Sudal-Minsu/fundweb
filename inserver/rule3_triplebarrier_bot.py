...
LOG_DIR = "/home/hddp2/visitor/Quant/logs"
...
def export_equity_png(out_path: str = os.path.join(RESULT_DIR, "equity_curve_3.png")):
    try:
...
def maybe_snapshot_equity(access_token, app_key, app_secret, force: bool=False):
    ...
    export_equity_png(os.path.join(RESULT_DIR, "equity_curve_3.png"))
